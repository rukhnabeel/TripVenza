...
const AgencyDocuments = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('Submitting agency documents...', formData);
            alert('Documents submitted successfully! Pending verification.');
        } catch (error) {
    ...
    return (
        <div className="max-w-7xl mx-auto p-6 space-y-8">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
                <h1 className="text-3xl font-bold mb-2">Agency Document Upload</h1>
                <p className="text-blue-100">Complete your KYC by uploading all required documents</p>
